                ...
                <div class="booking-content-wrapper">
                    ...
                    <div class="billing-info mb-50">
                        ...
                        <div class="billing-form form-wrapper">
                            {!! Form::open(['method'=>'POST','route' => [ 'host.storePhotos' ,app()->getLocale()], 'class'=>'dropzone']) !!}
                                <input type="hidden" name="owner_id" value="{{$host->id}}">
                            {!! Form::close() !!}
                            <a href="{{route('host.success',app()->getLocale())}}" class="cutom-btn"><button class="custom-btn">Done!</button></a>
