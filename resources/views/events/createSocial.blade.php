                ...
                <div class="booking-content-wrapper">
                    ...
                    <div class="billing-info mb-50">
                        ...
                        <div class="billing-form form-wrapper">
                            {!! Form::open(['method'=>'POST','route' => [ 'event.storeSocial' ,app()->getLocale()]]) !!}
                            ...
                            <div class="text-center">
                                ...
                                {{--<a href="{{route('createEventPhotos',[app()->getLocale(),$event->id])}}" class="cutom-btn"><button class="custom-btn">Skip!</button></a>--}}
                            </div>
                            {{Form::close()}}
                        </div>
                        <!-- billing-form - end -->
